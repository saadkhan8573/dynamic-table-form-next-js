...
const page = () => {
  ...
  console.log("Saad Khan", methods.getValues("fields"), table);
  ...
  console.log("Saad", methods.getValues("fieldsData"));
    ...
    <div>
      ...
      <table className="border min-w-[600px] mt-20 ">
        ...
        {table?.map((tab: any) => {
          console.log(
            "Tab",
            Object.values(tab).map((value: any) => <td>{value}</td>)
          );
          return (
            <tr className="border">
